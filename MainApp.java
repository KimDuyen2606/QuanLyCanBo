...
public class MainApp {
	...
	private static int thangphathanh;
	private static int sophathanh;
	private static int soluongphathanh;
   ...
   private static void readFromFile(IManager manager) {
		...
		private static void readBao(IManager manager, String line) {
			...
			manager.add(new Bao(maTaiLieu, tennhaxuatban, soluongphathanh, sophatHanh));
		}
